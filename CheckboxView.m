...
- (void)drawRect:(CGRect)rect
{
    ...
    {
        if (_style == CheckboxViewStyleOpenCircle)
        {
            [self drawRectOpenCircle:rect];
        }
        else if (_style == CheckboxViewStyleGrayedOut)
        {
...
// Vectorial graphics generated with PaintCode
